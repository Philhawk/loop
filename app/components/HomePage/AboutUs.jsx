  ...
  render() {
    return (
      <div className="aboutus">
        <a name="about-us" alt="page jump"></a>
        <div className="row">
        ...
        <div className="row whatsummary">
          <div className="col s12 m3 l3 head-shot">
            <img className="circle responsive-img" src="img/aboutUs/AndrewCropped.JPG" alt="Headshot of Andrew Agionfriddo" />
          ...
          <div className="col s12 m3 l3 head-shot">
            <img className="circle responsive-img" src="img/aboutUs/GeorgeCropped.JPG" alt="Headshot of George Smith-Sweeper" />
